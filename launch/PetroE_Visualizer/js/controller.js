  ...
  switch(plan) {
    ...
    case "TraditionalPlanProposed": 
      ...
      for (let i = 0; i < this.TraditionalPlanProposedLegendBtns.length; i++) {
          ...
          if (found == false) {
            if (this.TraditionalPlanProposedLegendBtns[i].classList.contains("legendbutton-pressed")) {
          ...
          if (found == true) {
            if (this.TraditionalPlanProposedLegendBtns[i].classList.contains("legendbutton")) {
    ...
    case "CoopPlanProposed": 
      ...
      for (let i = 0; i < this.CoopPlanProposedLegendBtns.length; i++) {
          ...
          if (found == false) {
            if (this.CoopPlanProposedLegendBtns[i].classList.contains("legendbutton-pressed")) {
          ...
          if (found == true) {
            if (this.CoopPlanProposedLegendBtns[i].classList.contains("legendbutton")) {
